          ...
          <div class="card-body p-0">
            <ul class="list-group list-group-flush rounded-3">
              ...
              <li class="btn list-group-item d-flex  align-items-center gap-3 ps-5">
                ...
                <p class="mb-0">Agendar Procedimentos</p>
              </li>
              <li class="btn list-group-item d-flex  align-items-center gap-3 ps-5">
                <i class="fa fa-solid- fa-calendar-plus" style="color: #3b5998;"></i>
                <p class="mb-0">Listagem dos Procedimentos</p>
              </li>
              <li class="btn list-group-item d-flex  align-items-center gap-3 ps-5">
                <i class="fa fa-solid- fa-calendar-plus" style="color: #3b5998;"></i>
                <p class="mb-0">Visualizar Resultados</p>
              </li>
              <li class="btn list-group-item d-flex  align-items-center gap-3 ps-5">
                <i class="fa fa-solid- fa-calendar-plus" style="color: #3b5998;"></i>
                <p class="mb-0">Visualizar RCU</p>
              </li>
              <li class="btn list-group-item d-flex  align-items-center gap-3 ps-5">
                <i class="fa fa-solid- fa-calendar-plus" style="color: #3b5998;"></i>
                <p class="mb-0">Enviar SMS</p>
              </li>
              <li class="btn list-group-item d-flex  align-items-center gap-3 ps-5">
                <i class="fa fa-solid- fa-calendar-plus" style="color: #3b5998;"></i>
                <p class="mb-0">Listagem de SMS</p>
              </li>
              <li class="btn list-group-item d-flex  align-items-center gap-3 ps-5">
                <i class="fa fa-solid- fa-calendar-plus" style="color: #3b5998;"></i>
                <p class="mb-0">Historico Financeiro</p>
              </li>
              <li class="btn list-group-item d-flex  align-items-center gap-3 ps-5">
                <i class="fa fa-solid- fa-calendar-plus" style="color: #3b5998;"></i>
