        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0">Registrar Tipo de Consulta</h3>
                </div>
            </div>
        </div> <!-- Row end  -->
        <div class="row mb-3">
            <div class="col-sm-12">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form id="form_store_full_consulta">
                            @csrf
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    <label for="nome" class="form-label">Nome do Tipo de Consulta</label>
                                ...
                                <div class="col-md-12">
                                    <label for="descricao" class="form-label">Descrição do Tipo de Consulta</label>
...
<script src="{{asset('js/Admin/cadastro/tipoConsulta.js')}}"></script>
